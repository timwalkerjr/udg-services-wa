...
- initial (initial): 1920×1080, scroll 0; DOM: data/pages/contact.source/state-0.html.
- scrolled (scroll): 1920×1080, scroll 1198; DOM: data/pages/contact.source/state-1.html.
- returned (return): 1920×1080, scroll 0; DOM: data/pages/contact.source/state-2.html.

## Starting implementation

Native iframe URLs, authored dimensions and form presence: data/pages/contact.widgets.json. Reuse these exact embed URLs; measured dimensions describe one viewport, not fixed responsive rules.
