...
- initial (initial): 1920×1080, scroll 0; DOM: data/pages/reviews.source/state-0.html.
- scrolled (scroll): 1920×1080, scroll 1646; DOM: data/pages/reviews.source/state-1.html.
- returned (return): 1920×1080, scroll 0; DOM: data/pages/reviews.source/state-2.html.

## Starting implementation

Native iframe URLs, authored dimensions and form presence: data/pages/reviews.widgets.json. Reuse these exact embed URLs; measured dimensions describe one viewport, not fixed responsive rules.
